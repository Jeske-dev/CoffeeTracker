...
export const TASTE_LEVELS = ["too_sour", "slightly_sour", "balanced", "slightly_bitter", "too_bitter"] as const;

export type TasteLevel = (typeof TASTE_LEVELS)[number];

export const TASTE_LEVEL_VALUES: Record<TasteLevel, { taste: ShotTaste; rating: number; label: string }> = {
